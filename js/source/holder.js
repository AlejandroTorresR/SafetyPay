...
$(document).ready(function(){
	...
	$(".onlyMobile > button").click(function(){
		$(".hideMobile").fadeIn("slow",function(){
			$("body").animate({ 'scrollTop' : 474 },'slow',function(){
				$(".col-md-4:first").fadeOut();
			});
		});
	});

	$(".returnMobile").click(function(){
		$(".hideMobile").fadeOut("slow",function(){
			$("body").animate({ 'scrollTop' : 0 },'slow',function(){
				$(".col-md-4:first").fadeIn("slow");
			});
		});
	});
});
